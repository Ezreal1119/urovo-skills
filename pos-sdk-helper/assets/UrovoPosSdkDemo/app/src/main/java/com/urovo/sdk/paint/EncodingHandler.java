...
public class EncodingHandler {
     ...
     * @return
     */
    public static Bitmap creatBarcode(String contents, int desiredWidth, int desiredHeight, boolean displayCode, int marginW, BarcodeFormat barcodeFormat) {
     ...
     * @return
     */
    protected static Bitmap mixtureBitmap(Bitmap first, Bitmap second, PointF fromPoint, int marginW) {
