...
name: switch_debug
version: 1.0.0
description: Add device SNs into the PCTool debug/developer switch system(切机/切debug), so the device can be switched to Debug Mode by PCTool.
category: switch_debug
---
...
`node /Volumes/SSD1T/SharedFiles/hermes_workspace/browser-agent/login_debug_switch_system.js <sn> "<customer_name>"`

Example:

`node /Volumes/SSD1T/SharedFiles/hermes_workspace/browser-agent/login_debug_switch_system.js 801625447436 "001"`
...
`node /Volumes/SSD1T/SharedFiles/hermes_workspace/browser-agent/login_debug_switch_system_delete_sn.js <sn>`

Example:

`node /Volumes/SSD1T/SharedFiles/hermes_workspace/browser-agent/login_debug_switch_system_delete_sn.js 801625447436`
...
`node ~/browser-agent/login_debug_switch_system.js <sn> "<customer_name>"`
